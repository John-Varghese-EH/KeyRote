    ...
    <html lang="en" suppressHydrationWarning>
      ...
      >
        ...
        >
          ...
          <footer className="w-full py-20 px-6 md:px-12 bg-background border-t border-border relative overflow-hidden mt-auto">
              ...
              <div className="space-y-4 md:col-span-3">
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <a href="https://patreon.com/johnvarghese" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center py-2 px-2 bg-[#FF424D] text-white font-medium rounded-lg hover:bg-[#FF424D]/90 transition-all hover:scale-[1.02] active:scale-95 text-[11px] sm:text-xs border border-[#FF424D]/50" title="Support on Patreon">
                      Patreon
                    </a>
                    <a href="https://github.com/sponsors/John-Varghese-EH" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center py-2 px-2 bg-zinc-800 dark:bg-white text-white dark:text-black font-medium rounded-lg hover:opacity-90 transition-all hover:scale-[1.02] active:scale-95 text-[11px] sm:text-xs border border-border" title="GitHub Sponsors">
                      GitHub
                    </a>
                    <a href="upi://pay?pa=johnvarghese@noxpay" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center py-2 px-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-lg hover:opacity-90 transition-all hover:scale-[1.02] active:scale-95 text-[11px] sm:text-xs border border-blue-500/50" title="NoxPay UPI">
                      NoxPay
                    </a>
                  </div>
                </div>
