    ...
    <div className="flex min-h-screen flex-col overflow-x-hidden">
      ...
      <main id="features" className="flex-1 w-full relative z-10 py-32 px-6 md:px-12 bg-background">
        <div className="max-w-6xl mx-auto space-y-40">
          ...
          >
            <p className="text-xs font-bold tracking-[0.2em] text-muted-foreground uppercase">Transparently Proxies All Major Providers</p>
            <div className="flex flex-wrap justify-center items-center gap-10 md:gap-20 opacity-40 grayscale dark:invert-0 invert transition-all duration-700 hover:grayscale-0 hover:opacity-100">
              <span className="text-2xl font-bold font-sans tracking-tight">OpenAI</span>
              <span className="text-2xl font-serif italic tracking-tight">Anthropic</span>
              <span className="text-2xl font-bold font-sans text-blue-500 tracking-tighter">Google Gemini</span>
              <span className="text-2xl font-bold font-mono tracking-widest">GROQ</span>
              <span className="text-2xl font-semibold tracking-tight text-green-500">NVIDIA NIM</span>
              <span className="text-2xl font-bold tracking-tight text-purple-500">OpenRouter</span>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="text-center space-y-6 relative z-10">
              <h2 className="text-4xl md:text-6xl font-bold tracking-tighter">Uncompromising Performance.</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
              <div className="p-10 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-md text-center space-y-4 transition-transform hover:scale-[1.02]">
                <Zap className="w-8 h-8 mx-auto text-white/50 mb-6" />
                <h4 className="text-6xl font-black tracking-tighter">&lt;5ms</h4>
                <p className="opacity-60 font-medium tracking-wide">Latency Overhead</p>
              </div>
              <div className="p-10 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-md text-center space-y-4 transition-transform hover:scale-[1.02]">
                <Globe className="w-8 h-8 mx-auto text-white/50 mb-6" />
                <h4 className="text-6xl font-black tracking-tighter">100%</h4>
                <p className="opacity-60 font-medium tracking-wide">Edge Compatible</p>
              </div>
              <div className="p-10 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-md text-center space-y-4 transition-transform hover:scale-[1.02]">
                <Lock className="w-8 h-8 mx-auto text-white/50 mb-6" />
                <h4 className="text-6xl font-black tracking-tighter">Zero</h4>
                <p className="opacity-60 font-medium tracking-wide">Telemetry Collected</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative p-10 md:p-16 lg:p-20 flex flex-col lg:flex-row items-center gap-16">
              <div className="flex-1 space-y-8">
                <h3 className="text-4xl font-bold tracking-tighter">1-Click Integration.</h3>
                <p className="text-xl text-muted-foreground leading-relaxed">
                  Replace your provider's base URL with your KeyRote instance. No SDK changes required.
                </p>
                <div className="bg-[#0D0D0D] text-zinc-300 p-8 rounded-2xl overflow-x-auto text-sm md:text-base font-mono border border-white/5 shadow-2xl">
                  <pre>
